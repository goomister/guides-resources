...
What's more, the treasure sets you get in ItF are different from those you find in EoC. The most notable difference is the presence of fruit and crystal treasure sets.

Fruits increase the quality of anti-trait abilities, such as status effect duration and massive damage multipliers. The specific sets are Void Fruit (for black enemies), Blood Fruit (red), Sky Fruit (floating) and Heaven’s Fruit (angel).
...
Most players tend to repeatedly get stuck when playing through ItF, and a lot of the time, it’s because their unit levels are very lackluster. Why? Because playing through ItF alone gives you very little XP, and no Leaderships at all. For that reason, it’s better to start playing through some events, early ranks of Catclaw Championship, and collect all of the EoC perfect treasures before starting ItF, as they give you a lot more resources to upgrade your cats and progress. Stories of Legend (also known as the Legend Stages) give plenty of xp as well early on. They’re advised to be done in parallel with ItF.

This is more of an opinion than something you should follow very precisely, but here’s an example of the ideal progression:
...
There are some of the earlier SoL chapters in higher crown difficulties. Even though you’ll want to do them at some point, I won’t suggest doing so this early, for reasons I will explain later.
...
<!-- TODO: remove spica, as it is not really worth it with bcwiki being just fine-->
...
The Miraheze Wiki, specifically, now has the Cat Stats Tool in addition to the resources we had. The tool can be useful for searching up unit stats and information, and comparing multiple units with one another.

If you are in the r/bc Discord server, you also have access to CatBot.
...
- **Flying**, the true form of Bird cat. A very powerful AoE (Area of effect) attacker, though its low range remains a problem. It's still good to use against some shorter ranged enemies like Cyberhorn, or against single target enemies like LeMurr. It also gains the ability to weaken angels, though usage of the ability is mostly irrelevant.
...
You don’t need to get all of these right away, but the most important ones are Cat and Tank. The other ones are also very good (for the most part), but they’re not quite as vital for ItF. Apart from **better overall stats**, here are the main differences between Normals and Crazed:
...
| Gross/Sexy Legs | Mid (less important if you have vaulter/nymph)                                                     |
| Cow/Giraffe     | Mid/Low (depending on how much you want unit that’s mostly used for speedrunning/treasure farming) |
| Bird/UFO        | Mid (less important if you have Salon/Figure Skating/Cameraman)                                    |
| Fish/Whale      | Mid                                                                                                |
| Lizard/Dragon   | High                                                                                               |
| Titan           | Mid/Low                                                                                            |
...
<!-- TODO: add upgraded catfruit stages -->
...
There are many other good ones, but those listed here are the ones you should worry about at first. Highlighted True Forms are those that do great in ItF specifically, while the others are just good early TFs that aren’t necessary for ItF, and are therefore at a lower priority.
...
Out of all the event stages, a few of them stand out for being significantly more crucial, as they drop free units that will boost the speed of progression. Cyclone stages, for instance, feature the imposing Cyclone Family enemies. However, they’re very susceptible to crown control abilities, and beating them has a 30% chance to drop certain units. These cyclone units will help you beat metal enemies you’ll encounter. Cyclone stages appear on a weekly schedule.

Another set of stages are the Behemoth Culling maps, named Hidden Forest of Gapra, Ashvini Desert (unlock after ItF1), and Jinfore Volcano (unlock after ItF3). These stages contain a subclass of fierce enemies referred to as Behemoths. Clearing these stages have a chance to drop behemoth stones upon clearing, which are upgrade materials that can be used to unlock the True Forms of the Eggs you get from reaching criterias of stage beaten in the Behemoth Culling maps.

### Enigma Stages

Another thing to note: once you get Ururun, _Enigma Maps_ are now unlocked. After clearing any legend/event stage, there’s a chance to get an enigma map drop out of 3 different rarities. Each rarity contains different sets of stages, which all give various rewards for clearing. The more energy you spend, the more likely you’ll get an enigma map to drop.

Since Enigma Stages comes from spending energy, and there will be higher tiers of Enigma Level and Hunter’s Map as you progress, it is suggested to wait until you unlock Hunter’s Map III before doing SoL content with higher crowned difficulty. You will be spending a lot of energy while going through them, and those energies will be converted into Enigma Maps, aiding you with amassing egg true forms. This is contrary to the old mindset, that you would want to start Crowned SoL as soon as possible, even before finishing 1 crown. That is to say, instead of rushing crowned SoL right off the bat, you might wish to delay it after Hunter’s Map II and III for easier Behemoth Stone grinding.
...
**[Beginner’s Guide](https://youtu.be/pCbIteKR6vA?si=isfUSUeiM0Ejmnbo)** \
...
**[How to properly follow guides](https://youtu.be/L2iLuBsQMe8)** \
**[For more, refer to this playlist](https://www.youtube.com/playlist?list=PLzqgIrlGHdEfRmY5pPb9Cjr7CqXxshcvh)**
